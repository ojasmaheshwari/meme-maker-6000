...
export const closeEmojiOverlayButton = document.querySelector('#close-emoji-overlay');
export const emojiOverlay = document.querySelector('.emoji-overlay');
export const insertEmojiButton = document.querySelector('#insert-emoji');
export const searchEmojiElem = document.querySelector('#search-emoji');
export const emojiSpace = document.querySelector('.emoji-space');
